...
if uploaded_file is not None:
    ...
    if matches:
        ...
        top_responses = st.selectbox('Select top responses', ['Top 3', 'Top 5', 'All'])

        if top_responses == 'Top 3':
            most_common_responses = [resp for resp, freq in counter.most_common(3)]
        elif top_responses == 'Top 5':
            most_common_responses = [resp for resp, freq in counter.most_common(5)]
        else:
            most_common_responses = [resp for resp, freq in counter.most_common()]
